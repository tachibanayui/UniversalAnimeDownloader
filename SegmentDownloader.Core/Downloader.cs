    ...
    public class Downloader
    {
        ...
        private void StartDownloadThreadProc(object objSegmentCount)
        {
            ...
            do
            {
                ...
                try
                {
                    remoteFileInfo = defaultDownloadProvider.GetFileInfo(this.ResourceLocation, Headers, out inputStream);
                    break;
                }
        ...
        private void RestartDownload()
        {
            ...
            do
            {
                ...
                try
                {
                    newInfo = defaultDownloadProvider.GetFileInfo(this.ResourceLocation, Headers, out stream);
            ...
            try
            {
                ...
                {                    
                    ...
                    while (location != this.ResourceLocation)
                    {
                        ...
                        RemoteFileInfo tempRemoteInfo = provider.GetFileInfo(location, Headers, out tempStream);
                    ...
                    segment.InputStream = provider.CreateStream(location, segment.StartPosition, segment.EndPosition, Headers);
