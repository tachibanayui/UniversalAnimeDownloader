...
namespace SegmentDownloader.Core
{
    public class DownloadManager
    {
        ...
        public Downloader Add(ResourceLocation rl, ResourceLocation[] mirrors, string localFile, int segments, bool autoStart, WebHeaderCollection request = null)
        {
            Downloader d = new Downloader(rl, mirrors, localFile, segments, request);
            Add(d, autoStart);
